...
public class MainActivity extends AppCompatActivity {
    ...
    public void showSpinner(View source) {        // 调用静态方法显示环形进度条
        ProgressDialog.show(this, "任务执行中"
                , "任务执行中，请等待", false, true); // ①context,title,message,indeterminate,cancelable
    }
    public void showIndeterminate(View source) {
        ...
        pd1.setProgressStyle(ProgressDialog.STYLE_HORIZONTAL);  // 设置对话框的进度条风格.spinner
